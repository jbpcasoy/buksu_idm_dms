...
export default function Sidebar() {
  ...
  return (
    <aside
      id='logo-sidebar'
      className='fixed top-0 left-0 z-60 w-64 h-screen pt-20 transition-transform -translate-x-full bg-CITLDarkBlue border-r border-gray-200 sm:translate-x-0  dark:bg-gray-800 dark:border-gray-700'
      aria-label='Sidebar'
    >
          ...
          {user?.ActiveFaculty?.ActiveDean && (
            <li>
              <Link
                href='/department'
                className={`flex items-center p-2 text-base font-normal text-CITLWhite rounded-lg  hover:bg-CITLGray-main ${
                  router.asPath === "/department" ? "bg-CITLGray-main" : ""
                }`}
              >
                <svg
                  fill='none'
                ...
                <span className='flex-1 ml-3 whitespace-nowrap'>College</span>
              </Link>
            </li>
          )}
          ...
          {user?.ActiveFaculty && (
            <li>
              <Link
                href='/faculty'
                className={`flex items-center p-2 text-base font-normal text-CITLWhite rounded-lg  hover:bg-CITLGray-main ${
                  router.asPath === "/faculty" ? "bg-CITLGray-main" : ""
                }`}
              >
                <svg
                  fill='none'

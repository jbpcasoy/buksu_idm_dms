...
export const data = {
  ...
  datasets: [
    {
      label: "IM Drafts",
      data: [12, 15, 8, 10, 1, 5, 1, 8, 10, 1, 5, 1],
      // fill: true,
...

    {
      ...
      data: [3, 5, 10, 5, 10, 20, 15, 10, 5, 10, 20, 15],
    ...
    },
    {
      label: "To be revised",
      fill: true,
      data: [10, 2, 10, 18, 15, 16, 3, 10, 18, 15, 16, 3],
    ...
    },
    {
      label: "Under review",
      fill: true,
      data: [15, 23, 15, 22, 18, 22, 19, 15, 22, 18, 22, 19],
...
export function NumberOfDepartmentIMs() {
  return (
    <div className='bg-CITLGray-light  m-2 px-2.5  rounded-lg border border-CITLGray-lighter '>

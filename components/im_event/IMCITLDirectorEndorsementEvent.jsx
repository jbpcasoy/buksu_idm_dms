...
export default function IMCITLDirectorEndorsementEvent({ iMEvent }) {
  return (
    <li className='mb-10 ml-6'>
      ...
      <p className='mb-4 text-sm font-normal text-gray-500 dark:text-gray-400'>
        ...
        <span className='font-semibold text-green-400'>
          &quot;
          {
            iMEvent?.CITLDirectorEndorsement?.IMDCoordinatorEndorsement?.IM
              ?.title
          }
          &quot;
        </span>{" "}
        ...
        <span className='font-semibold text-CITLDarkBlue'>
          {iMEvent?.CITLDirectorEndorsement?.CITLDirector?.User?.name}
        </span>
        .
      </p>
    </li>

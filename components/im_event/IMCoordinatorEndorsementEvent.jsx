...
export default function IMCoordinatorEndorsementEvent({ iMEvent }) {
  return (
    <li className='mb-10 ml-6'>
      ...
      <p className='mb-4 text-sm font-normal text-gray-500 dark:text-gray-400'>
        ...
        <span className='font-semibold text-green-400'>
          &quot;{iMEvent?.CoordinatorEndorsement?.IM?.title}&quot;
        </span>{" "}
        was endorsed by{" "}
        <span className='font-semibold text-CITLDarkBlue'>
          {iMEvent?.CoordinatorEndorsement?.Coordinator?.Faculty?.user?.name}
        </span>
        .
      </p>
    </li>

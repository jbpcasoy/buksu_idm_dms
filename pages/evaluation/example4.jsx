          ...
          <div className="p-5 w-full">
            ...
            <div className="px-6 pt-16 md:w-full ">
              ...
              <ImercQuestion
                ...
                question="They motivate students to participate in the learning process."
              />

              <div className="flex p-2 mt-4">
                <Link
                  href="/evaluation/example3"
                ...
                <div className="flex-auto flex flex-row-reverse">
                  <Link
                    href="/evaluation/example5"
                    className="text-base  ml-2  hover:scale-110 focus:outline-none flex justify-center px-4 py-2 rounded font-bold shadow-xl cursor-pointer hover:bg-CITLOrange   bg-CITLDarkBlue text-CITLWhite"
                  >
                    Next
                  </Link>
                </div>

              ...
              <div className='m-5 relative bg-white opacity-90 rounded-lg shadow-lg '>
                <div className='px-6 py-12 mt-64 justify-center lg:px-8'>
                  ...
                  <form className='space-y-4' action='#'>
                    <button
                      type='submit'
                      className='w-full text-CITLDarkBlue  focus:ring-2 focus:ring-inset focus:ring-CITLDarkBlue bg-white/5 p-2 ring-1 ring-white/10 border  font-medium rounded-lg text-sm px-5 py-2.5 text-center '
                    >
                      Login as Faculty
                    </button>
                    <button
                      type='submit'
                      className='w-full text-CITLWhite bg-CITLDarkBlue hover:opacity-90 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500 font-medium rounded-lg text-sm px-5 py-2.5 text-center '
                    >
                      Login as Admin
                    </button>
                  </form>

        ...
        <div className="flex items-center border border-CITLGray-lighter  bg-CITLGray-light m-2 p-3 relative rounded-lg shadow-lg overflow-hidden">
          <div className="p-5 w-full">
            ...
            <div className="px-6 pt-16 md:w-full ">
              ...
              <ImercQuestion
                title="The Preface"
                question="The preface is written by the author/s himself/ herself/ themselves."
              />

              <div className="flex p-2 mt-4">
                <Link
                  href="/evaluation/title2"
                  className="text-base  flex justify-center px-4 py-2 rounded font-bold cursor-pointer hover:border-CITLOrange hover:text-CITLOrange shadow-xl bg-gray-100 text-CITLGray-main border border-CITLGray-main"
                >
                  Previous
                </Link>
                <div className="flex-auto flex flex-row-reverse">
                  <Link
                    href="/evaluation/preface2"

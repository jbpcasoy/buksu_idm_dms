          ...
          <div className="p-5 w-full">
            ...
            <div className="px-6 pt-16 md:w-full ">
              ...
              <ImercQuestion
                ...
                question="The learning outcomes are appropriate for the topics covered."
              />

              <div className="flex p-2 mt-4">
                <Link
                  href="/evaluation/learning_outcomes2"
                ...
                <div className="flex-auto flex flex-row-reverse">
                  <Link
                    href="/evaluation/discussion1"
                    className="text-base  ml-2  hover:scale-110 focus:outline-none flex justify-center px-4 py-2 shadow-xl rounded font-bold cursor-pointer hover:bg-CITLOrange   bg-CITLDarkBlue text-CITLWhite"
                  >
                    Next
                  </Link>
                </div>

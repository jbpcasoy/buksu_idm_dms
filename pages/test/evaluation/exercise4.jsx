          ...
          <div className='p-5 w-full'>
            ...
            <div className='px-6 pt-16 md:w-full '>
              ...
              <ImercQuestion
                ...
                question='They encourage students to communicate effectively.'
              />

              <div className='flex p-2 mt-4'>
                <Link
                  href='/evaluation/exercise3'
                  className='text-base  flex justify-center px-4 py-2 rounded font-bold shadow-xl cursor-pointer  hover:border-CITLOrange hover:text-CITLOrange bg-gray-100  text-CITLGray-main  border  border-CITLGray-main'
                >
                  Previous
                </Link>
                <div className='flex-auto flex flex-row-reverse'>
                  <Link
                    ...
                    className='text-base  ml-2  hover:scale-110 focus:outline-none flex shadow-xl justify-center px-4 py-2 rounded font-bold cursor-pointer hover:bg-CITLOrange   bg-CITLDarkBlue text-CITLWhite'
                  >
                    Next
                  </Link>
                </div>
